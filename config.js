...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "pk~PxQ1mSTC#501C3DMSIoJ_Ob81ZdvTBa-w7ZaQb18dxvusXB8G5Ns",
AUTO_STATUS_SEEN: process.env.AUTO_STATUS_SEEN || "true",
AUTO_STATUS_REPLY: process.env.AUTO_STATUS_REPLY || "false",
AUTO_STATUS_REACT: process.env.AUTO_STATUS_REACT || "true",
AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*SEEN YOUR STATUS BY █▓▒▒░░░KURIMUZON♦️░░░▒▒▓█*",
...
BOT_NAME: process.env.BOT_NAME || "█▓▒▒░░░KURIMUZON♦️░░░▒▒▓█",
STICKER_NAME: process.env.STICKER_NAME || "CRIMSON",
CUSTOM_REACT: process.env.CUSTOM_REACT || "false",
CUSTOM_REACT_EMOJIS: process.env.CUSTOM_REACT_EMOJIS || "♦️",
DELETE_LINKS: process.env.DELETE_LINKS || "true",
OWNER_NUMBER: process.env.OWNER_NUMBER || "2349075268689",
OWNER_NAME: process.env.OWNER_NAME || "𝗖𝗥𝗜𝗠𝗦𝗢𝗡",
